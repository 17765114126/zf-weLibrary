...
//}
//运行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/result6.png
...
//}
//运行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/result7.png
...
//可以将 ars.suspendRequest()代码后的 sleep 代码去掉，或将休眠时间改为 200（明显小于 300 即可）后，查看执行结果，会发现结果中依然会有出现 false 的情况。如下图所示：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/result8.png
