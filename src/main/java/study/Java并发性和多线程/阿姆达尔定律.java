...
//首先，一个程序可以被分割为两部分，一部分为不可并行部分 B，一部分为可并行部分 1–B。如下图：
    //https://wiki.jikexueyuan.com/project/java-concurrent/images/24.png
//在顶部被带有分割线的那条直线代表总时间 T(1)。
//
//下面你可以看到在并行因子为 2 的情况下的执行时间：
    //https://wiki.jikexueyuan.com/project/java-concurrent/images/25.png
//并行因子为 3 的情况：
    //https://wiki.jikexueyuan.com/project/java-concurrent/images/26.png
//优化算法
