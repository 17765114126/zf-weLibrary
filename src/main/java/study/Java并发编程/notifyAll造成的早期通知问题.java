 ...
 * @date 2020-{MONTH}-{DAY}
 */
public class notifyAll造成的早期通知问题 {
...
//}
//执行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/notifyall.jpg
...
//
//修改后的执行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/niotifyall1.jpg
