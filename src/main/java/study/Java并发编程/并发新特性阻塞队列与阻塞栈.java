package study.Java并发编程;

/**
 * @author zhaofu
 * @date 2020-{MONTH}-{DAY}
 */
public class 并发新特性阻塞队列与阻塞栈 {
//阻塞队列
...
//}
//输出结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/queue.jpg
...
//}
//执行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/blockqueue.jpg
...
//}
//执行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/blockqueue1.jpg
//程序依然会阻塞等待，我们改为如下代码：
//
//import java.util.concurrent.BlockingDeque;
//import java.util.concurrent.LinkedBlockingDeque;
...
//}
//执行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/blockdeque.jpg
