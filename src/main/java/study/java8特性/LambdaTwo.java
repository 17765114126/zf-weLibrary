...
* @FunctionalInterface
*/
public interface WorkerInterfaceTwo {
 ...
 */
@FunctionalInterface
public interface WorkerInterfaceThree {
...
public static void Test4() {
    ...
    list0.stream().map((x) -> x * x).forEach(System.out::println);
    ...
    sum = list2.stream().map(x -> x * x).reduce((x, y) -> x + y).get();
    System.out.println(sum);
}
