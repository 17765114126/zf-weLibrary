...
//}
//运行结果如下：
    //https://wiki.jikexueyuan.com/project/java-concurrency/images/modifyresults.jpg
//很明显，这其实并不符合使用 volatile 的第二个条件：该变量要没有包含在具有其他变量的不变式中。因此，在这里使用 volatile 是不安全的。
//
//附上一篇讲述 volatile 关键字正确使用的很好的文章：http://www.ibm.com/developerworks/cn/java/j-
}
